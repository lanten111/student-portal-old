...
//
//import static co.za.service.ServiceMapper.mapToStudent;
...
//        Student TrStudent = mapToStudent(studentTO);
...
//        Assertions.assertThrows(StudentWithSameStudentNumberExist.class, () -> {studentService.add(studentTO);});
...
//        Assertions.assertThrows(StudentWithSameEmailExist.class, () -> {studentService.add(studentTO);});
//        verify(studentRepository, never()).save(any());
//    }
//
//    @Test
